...
public class Comsol3Dcode {
	...
	public Model myfun_comsol_build(String PScoeff, String binsource, String savefile) {
	...
	public static String[] MTD_str(double[] x) {
	...
	public void myfun_comsol_load_constant() {
		extra_E_infi         = -0.55;                
	...
	public void myfun_comsol_load_epsilon_model(String data) throws Exception{
		try {
	...
	public void myfun_comsol_load_image(String imagefile) throws Exception{
		try {
	...
	public void myfun_comsol_create_model() {
	...
	public void myfun_comsol_create_structure() {
	...
	public void myfun_comsol_create_material() {
	...
	public void myfun_comsol_create_physics() {
		if (ACMode == 1) {
	...
	public void myfun_comsol_create_mesh() {
	...
	public void myfun_comsol_create_shifting_factors(double[] x) {
	...
	public void myfun_comsol_create_study() {
		if (ACbreakdown == 1) {
	...
	public void myfun_comsol_create_solution() {
		if (ACMode == 1) {
	...
	public void myfun_comsol_post_process(String savefile) {
		if (ACMode == 1) {
