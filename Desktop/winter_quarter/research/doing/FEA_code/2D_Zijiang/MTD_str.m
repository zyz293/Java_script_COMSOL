...
function [str_real,str_imag, str_Intreal, str_Intimag] = MTD_str(x)
% Input structure:
...
for i=1:NumOfTerms
    ...
    % Thresdhold value to separate alpha and beta relaxations
    tau0 = 1;
    % Modify DS1 DS2 TS1 TS2 to reflect alpha and beta relaxation in spectroscopy
