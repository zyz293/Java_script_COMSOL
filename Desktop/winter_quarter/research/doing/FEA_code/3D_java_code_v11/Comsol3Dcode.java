...
public class Comsol3Dcode {
	...
	public Model run() throws Exception {
		...
		****/
		...
		savefile = "HZ_3D_comsolbuild_"+strACMode+"_"+ImageType+"_"+dateFormat.format(date)+"_IP"+Double.toString(IP1)+"+"+Double.toString(IP2)+"_run_"+Double.toString(TrialNo);
