	...
	public Model run() throws Exception {
		...
		****/
		...
		if (graft == "monoPGMA") {
				...
				consttDeltaEpsilonShift2 = 1;
				consttConstEpsilonShift = 0;
				binsource = "./crop_PGMA_2wt%.txt";
				consttdimension_to_pixel = 400/240;
				consttdimension_to_pixel = 200/432;
				...
				consttDeltaEpsilonShift2 = 1;
				consttConstEpsilonShift = 0;
				binsource = "./crop_ferroPGMA_2wt%.txt";
				consttdimension_to_pixel = 200/432;
				...
				consttDeltaEpsilonShift2 = 1;
				consttConstEpsilonShift = 0;
				binsource = "./crop_terthiophenePGMA_2wt%.txt";
				consttdimension_to_pixel = 500/523;
				...
				consttDeltaEpsilonShift2 = 1;
				consttConstEpsilonShift = 0;
				binsource = "./crop_monothiophenePGMA_2wt%.txt";
				consttdimension_to_pixel = 500/523;
				...
				consttDeltaEpsilonShift2 = 1;
				consttConstEpsilonShift = 0;
				binsource = "./images/cropped_images/crop_anthracenePGMA_2wt%.txt";
				consttdimension_to_pixel = 400/240;			
		} else { // "bare"
				IF1mode = 0;
...
/* Move variables below to the beginning of file as material selection, polymer, particle, graft, vf, ipthick */			
			...
			source.reanmeTo(new File(wdir +"/" + source.getName()));
