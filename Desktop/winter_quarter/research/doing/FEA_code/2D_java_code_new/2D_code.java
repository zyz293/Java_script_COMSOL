...
public class 2D_code {
	...
	public static void main(String[] args) {
		Const const = new Const(1, 1, 1, 1, 0, 500/523);
		new code().MAIN(1, './crop_BS_1wt%', const);
	} 
...
/*******************************************************/	
		...
		String savefile = './HZ_2D_comsolbuild_'+strMode+'_'+ImageType+'_'+dateFormat.format(date)+'_IP'+Integer.toString(IP1)+'+'+Integer.toString(IP2)+'_run'+Integer.toString(TriaNo);
		...
		String savefile = './HZ_2D_comsolbuild_'+strACMode+'_'+ImageType+'_'+dateFormat.format(date)+'_IP'+Float.toString(IP1)+'+'+Float.toString(IP2)+'_run_'+Float.toString(TrialNo);
